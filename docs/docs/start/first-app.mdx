...
This scaffolds a SvelteKit frontend by default. To start with Dioxus instead, use `forge new my-app --minimal --target dioxus`.
...
The default scaffold uses SvelteKit, so you can use the generated TypeScript bindings like this:
...
```rust
use dioxus::prelude::*;
use crate::forge::use_list_todos_subscription;
