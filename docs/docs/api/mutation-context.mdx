...
The authentication context containing user information. Same as [QueryContext.auth](/docs/api/query-context#authcontext).
...
- [QueryContext](/docs/api/query-context) - For read-only operations
- [JobContext](/docs/api/job-context) - For background jobs
- [WorkflowContext](/docs/api/workflow-context) - For workflows
