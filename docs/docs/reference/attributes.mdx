...
| `read_only` | flag | none | MCP annotation hint (`readOnlyHint=true`) |
| `destructive` | flag | none | MCP annotation hint (`destructiveHint=true`) |
| `idempotent` | flag | none | MCP annotation hint (`idempotentHint=true`) |
| `open_world` | flag | none | MCP annotation hint (`openWorldHint=true`) |
