...
test.describe("Forge Demo", () => {
  ...
  test("creating user appears in list without page refresh", async ({
    page,
    gotoReady,
  }) => {
    await gotoReady();
  ...
  test("deleting user removes from list", async ({ page, gotoReady }) => {
    ...
    // Verify deletion persisted via reload to avoid SSE timing issues
    await page.reload();
